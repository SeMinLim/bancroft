...
map<pair<uint64_t, uint64_t>, pair<uint32_t, uint32_t>> reference;
...
int main() {
	char *filenameIn = "/mnt/ephemeral/sequence/GRCm39.fasta";
	char *filenameOut = "/mnt/ephemeral/reference/GRCm39Reference064MersFrom1IndexIncluded.bin";
